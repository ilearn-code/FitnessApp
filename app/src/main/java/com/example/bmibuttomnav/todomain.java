...
import com.example.bmibuttomnav.task_database.TaskContract;
import com.example.bmibuttomnav.task_database.TaskDatabaseHelper;

import java.util.ArrayList;

public class todomain extends AppCompatActivity {
    private static final String TAG = "MainActivity";
    private com.example.bmibuttomnav.task_database.TaskDatabaseHelper taskHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskHelper = new com.example.bmibuttomnav.task_database.TaskDatabaseHelper(this);
